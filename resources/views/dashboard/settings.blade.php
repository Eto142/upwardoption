...
<head>
    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-xl-9 col-lg-11 col-md-12 mb-4">
             <a href="{{url('profiledetail')}}" class="card text-decoration-none mb-3">
                <div class="card-body d-flex align-items-center">
                    <img src="profile.png" alt="Referral Icon" style="width: 40px; margin-right: 10px;">
            ...
            <!-- Referral Box -->
            <a href="{{url('notification')}}" class="card text-decoration-none mb-3">
                <div class="card-body d-flex align-items-center">
                    <img src="notification.png" alt="Referral Icon" style="width: 40px; margin-right: 10px;">
                    <h5 class="mb-0">Notifications</h5>
                </div>
            </a>
            <!-- Watchlist Box -->
            <a href="{{url('address')}}" class="card text-decoration-none mb-3">
                <div class="card-body d-flex align-items-center">
                    <img src="address.png" alt="Watchlist Icon" style="width: 40px; margin-right: 10px;">
                    <h5 class="mb-0">Update Address</h5>
                </div>
            </a>
            <!-- Withdrawals Box -->
            <a href="{{url('verification')}}" class="card text-decoration-none">
                <div class="card-body d-flex align-items-center">
                    <img src="verify.png" alt="Withdrawals Icon" style="width: 40px; margin-right: 10px;">
                    <h5 class="mb-0">Account Verifications</h5>
                </div>
            </a>
        </div>
